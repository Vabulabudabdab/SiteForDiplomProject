            ...
            <div class="page-content-wrapper bg-transparent m-0">
                <div class="height-10 w-100 shadow-lg px-4 bg-brand-gradient">
                    <div class="d-flex align-items-center container p-0">
                        ...
                        <a href="<?php echo "login" ?>" class="btn-link text-white ml-auto ml-sm-0">
                            Войти
                        </a>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 ml-auto mr-auto">
                                <div class="card p-4 rounded-plus bg-faded">
                                    <?php if(!empty($_SESSION['existsAlready'])): ?>
                                    <div class="alert alert-danger text-dark" role="alert">
                                        <strong>Уведомление!</strong> Этот эл. адрес уже занят другим пользователем.
                                    </div><?php unset($_SESSION['existsAlready']);?>
                                    <?php endif;?>

                                    <form id="js-login" novalidate="" method="post"  action="../Controllers/RegisterUser.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="emailverify" name="username" class="form-control" placeholder="Имя пользователя" required>
                                            <div class="invalid-feedback">Заполните поле.</div>
                                            <div class="help-block">Отображаемое имя</div>
                                        </div>
                                        <div class="form-group">
