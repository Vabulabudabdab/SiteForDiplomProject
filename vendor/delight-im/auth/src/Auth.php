...
//		$this->throttle([ 'enumerateUsers', $this->getIpAddress() ], 3, (60 * 60), 75);
//		$this->throttle([ 'createNewAccount', $this->getIpAddress() ], 3, (60 * 60 * 12), 5, true);

		$newUserId = $this->createUserInternal(false, $email, $password, $username);

//		$this->throttle([ 'createNewAccount', $this->getIpAddress() ], 3, (60 * 60 * 12), 5, false);
